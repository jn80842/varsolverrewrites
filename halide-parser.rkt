  ...
  (parser
   ...
   (grammar
    ...
    (exp [(NUM) $1]
         ...
         [(BROADCAST OP exp COMMA exp CP) (sigma-term 'broadcast (list $3 $5))]
  ...
  (parser
   ...
   (grammar
    ...
    (exp [(NUM) 0]
         ...
         [(TVAR) 0]
         [(NTVAR) 0]
         [(XBROADCAST OP exp CP) (+ 2 $3)]
         [(BROADCAST OP exp COMMA exp CP) (+ 1 $3 $5)]
         [(RAMP OP exp COMMA exp COMMA exp CP) (+ 1 $3 $5 $7)]
         [(TRUE) 0]
         [(FALSE) 0]
         [(UINT1) 0]
         [(UINT0) 0]
